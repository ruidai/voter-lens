    ...
    <div className="flex-1 flex flex-col justify-between p-6 bg-[#F9F9F7] text-[#111111]">
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? "INITIALIZING LOG..." : "CREATE VOTER LOG"}
        ...
        <div className="flex items-center gap-4 my-2">
          ...
          <span className="text-[10px] font-mono font-bold uppercase tracking-widest text-news-neutral-500">OR</span>
          <div className="flex-1 h-px bg-[#111111]"></div>
        </div>

        <button
          onClick={handleGoogleOAuth}
          className="w-full py-4 bg-transparent border-2 border-[#111111] hover:bg-news-neutral-100 text-[#111111] text-xs font-bold uppercase tracking-widest transition-colors flex items-center justify-center gap-2 outline-none"
        >
